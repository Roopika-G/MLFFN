# embedding.py
# Defines the Embedding class to load and manage pretrained word embeddings (FastText, Word2Vec).
# Provides methods to represent words, compute similarities, and subsample vocab.
